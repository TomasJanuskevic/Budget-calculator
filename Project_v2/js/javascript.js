...
countBtn.addEventListener('click', function () {
    if (appData.budget != undefined) {
        ...
        if (appData.moneyPerDay < 100) {
            levelValue.textContent = "Minimalus pajamu dydis";
        } else if (appData.moneyPerDay >= 100 && appData.moneyPerDay <= 1000) {
            levelValue.textContent = "Vidutinis pajamu dydis";
        } else if (appData.moneyPerDay > 1000) {
            levelValue.textContent = "Aukstas pajamu dydis";
        } else {
            levelValue.textContent = "Ivyko klaida";
        }
    } else {
        dayBudgetValue.textContent = "Ivyko klaida";
    }
});
